...
authority: two-desks-work-orders-and-trains@da1ace0
...
checked out at `da1ace0`. `node_modules` is a junction to the main checkout —
...
is part of it*:
    ...
    git -C D:/AddictedtoAI show da1ace0:openspec/changes/two-desks-work-orders-and-trains/specs/loop/spec.md
