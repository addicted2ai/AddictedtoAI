...
export const posts = [
  ...
  },
  {
    ...
    title:
      "Manus is splitting from Meta, and giving some users until 7:59 a.m. SGT on 23 August to back up their data",
    metaTitle:
      "Manus Is Splitting From Meta — Some Users Have Until 7:59 A.M. SGT On 23 August To Back Up Their Data",
    description:
      "On 11 August 2026 Manus announced it will return to independent operation after Meta's acquisition of it, which The Verge reports cost $2 billion and which China blocked — neither figure stated on Manus's own page. Data generated by some users on/after 29 December 2025 will be deleted 23-24 August SGT; the backup window closes 7:59 a.m. SGT on 23 August. Manus's FAQ states explicitly this is not a security incident.",
    excerpt:
      "Manus is returning to independent operation after Meta's blocked $2 billion acquisition. If your account is affected, the backup window for your data closes 7:59 a.m. SGT on 23 August — after that, it's gone for two days.",
