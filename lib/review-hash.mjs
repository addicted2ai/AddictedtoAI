 ...
 *
 * ONE key today. `pulse/lib/` appends dated events to an entry's `timeline`
 * under specs/review's exemption for deterministic machinery output. If a
 * future Pulse behaviour writes another key and this list is not updated,
 * mismatches appear on pieces nobody touched — a loud failure traceable to
 * this line, which is the trade this project takes over a silent gap.
 */
export const MECHANICAL_FRONT_MATTER_KEYS = Object.freeze(['timeline']);
