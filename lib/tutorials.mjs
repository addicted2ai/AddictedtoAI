...
import { daysBetween, todayIso, resolveFact, currentStatusOf } from './facts.mjs';

// Re-exported for anything that already imports `currentStatusOf` from here
// (nothing in this repo does as of addictedtoai-ij4h, which moved the
// definition to `facts.mjs` — see that file for why). Kept as a compatibility
// seam rather than a silent removal.
export { currentStatusOf };
