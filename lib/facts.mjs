...
export function renderFact(fact, ctx, opts = {}) {
  ...
  const quantity = (value) => {
    const v = `<span class="fact-value">${escapeHtml(value)}</span>`;
    if (!unit) return v;
    return `<span class="fact-quantity">${v}<span class="fact-unit">${escapeHtml(unit)}</span></span>`;
  };
