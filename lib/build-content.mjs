...
import { entryReviewGate, reviewJoin } from './reviews.mjs';
...
export async function buildSite(opts = {}) {
  ...
  for (const id of reviewGate.unapproved) {
    diags.warn({
      file: 'data/reviews/',
      field: 'verdict',
      message: `${id} — its prose body is not indexed (specs/wiki indexes on "a prose body that passed review")`,
