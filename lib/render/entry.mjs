...
export function renderClaims(doc, site) {
  ...
  const subjectName = doc.data.display_name;
  return el(
    'section',
    { class: 'section entry-claims', 'aria-labelledby': 'claims' },
    el('h2', { class: 'section-title', id: 'claims' }, 'What this party says about itself'),
    el(
      'ol',
      { class: 'claims' },
      claims
        .map((c) => {
          ...
          return el(
            ...
            el(
              ...
              el('span', { class: 'claim-src' }, escapeHtml(subjectName)),
