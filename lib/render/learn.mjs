...
const LEVEL_BLURBS = {
  orientation: 'You can look at any AI headline or product and know what kind of thing it actually is.',
  foundations: 'You can predict the failure, explain the quirk, and stop wondering why it did that.',
  mechanics: 'You can read a model card, a paper abstract or a serving-stack post and know what the named parts do.',
  advanced: 'You can weigh claims that experts still dispute, and tell which numbers are measured from which are guessed.',
};
