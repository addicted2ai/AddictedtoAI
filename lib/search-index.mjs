...
export function buildSearchIndex(corpus) {
   ...
   * INDEXABILITY JOIN. The grep found a FIFTH the task did not name — the route
   * table — and it is recorded below as its own row rather than swapped in for
   * one of the four, because "five surfaces were in play, not four" is itself
   * the finding, and a list that quietly substitutes one for another hides it.
   *
