...
/**
 * The six content types this change validates, and where each lives relative
 * to a content root. `delta` joined the list in task 4.14 (the Impossible →
 * Routine showpiece); its schema is in `schema.mjs` with the other five.
 */
export const CONTENT_TYPES = {
  ...
  delta: { dir: 'deltas', glob: 'deltas/**/*.md' },
};
