...
/**
 * The three refusals `checkPublishesFromValue` can return, each said in the
 * terms the editor needs to act on it.
 *
 * The `suffixShaped` branch is the one that has to say something other than
 * "declare the reduction": the reduction IS the public suffix, and telling an
 * editor to declare it is the build teaching the defect — `vendor.co.il` was
