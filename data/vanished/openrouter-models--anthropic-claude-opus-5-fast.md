---
title: "A declared feed row vanished: openrouter-models anthropic/claude-opus-5-fast"
...
`model/anthropic-claude-opus-5-fast` declares the row `anthropic/claude-opus-5-fast` from the `openrouter-models` feed, and that row is
...
| `links` | {"details":"/api/v1/models/anthropic/claude-opus-5-fast-20260723/endpoints"} |
...
| `reasoning` | {"default_effort":"high","default_enabled":true,"mandatory":false,"supported_efforts":["max","xhigh","high","medium","low"]} |
