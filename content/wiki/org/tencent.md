...
In the catalog as observed on 31 August 2026, `tencent/hy4-preview` was the
only one of Tencent's seven rows with no Hugging
Face id. The other six all had one, `tencent/hy3-preview` included, which
