...
- Hugging Face API records for Thomson-1.0-Small, Snowdon1.1-Small, Qwen3.6-35B-A3B and bartowski's GGUF conversion ([huggingface.co/api/models](https://huggingface.co/api/models/thomsonreuters/Thomson-1.0-Small))
