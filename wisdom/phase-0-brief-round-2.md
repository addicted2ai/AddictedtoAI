> **PROVENANCE.** Round 2's revision brief. It did not list the six findings as
> six fixes: it named the CLASS — a negative control that passes for a reason
> other than the property it names — and required a SWEEP, saying outright that
> the six were what one reviewer found in one session and the enumeration was
> the author's to complete. It came back with ten more nobody had named.
