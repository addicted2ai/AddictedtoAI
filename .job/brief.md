...
Clear the 3 carried findings on content/blog/openai-gpt-6-astra-system-card.md

- **Target**: `content/blog/openai-gpt-6-astra-system-card.md`

3 findings carried by reviewers against `content/blog/openai-gpt-6-astra-system-card.md`, batched into one job because they concern the same file. Each is stated below in the reviewing reviewer's own words. Fix every one, or say in `RESULT.md` which you did not and why — a finding you leave standing must keep its file.

### Restore the card's hedge in the steganography quote

Carried in `data/carried/j-20260904-04-carry-1.md`.
...
### Name the condition the sub-11% WMDP recall figure belongs to

Carried in `data/carried/j-20260904-04-carry-2.md`.
...
### The SRE-Bench four-attempt pair is release-page prose, not a table row

Carried in `data/carried/j-20260904-04-carry-3.md`.
...
- `data/carried/j-20260904-04-carry-1.md`
- `data/carried/j-20260904-04-carry-2.md`
- `data/carried/j-20260904-04-carry-3.md`
