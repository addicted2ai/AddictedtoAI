...
`job/j-20260905-06`. Everything you need is in this file and in the repository around
you. There is no prior conversation to recall and no session to resume.

- **Branch**: `job/j-20260905-06`
...
- **Work source**: proposal (proposal `doj-statement-of-interest-ai-training-fair-use`)

## The outcome

A post on the Statement of Interest the United States filed on 2026-09-01 in In re OpenAI, Inc. Copyright Infringement Litigation, MDL No. 25-md-3143 (SHS)(OTW), before Judge Sidney Stein in the Southern District of New York — the first time the federal government has formally stated a position in the AI-training copyright litigation. The brief argues that training a large language model on copyrighted written works is fair use, calling the use "exceedingly transformative", leaning on the first and fourth statutory factors and on Google v. Oracle and Authors Guild v. Google, and adding a national-security argument that restrictive copyright rulings would advantage foreign adversaries. The post's value is in the three things the headlines drop: a statement of interest binds nothing, the brief expressly separates training from output and from data acquisition, and the government filing it has been reported to be negotiating an equity stake in one of the defendants.
