...
### Re-cite lib/changes.mjs:60-67 against feedRowIndex's current location

Carried in `data/carried/j-20260907-15-carry-1.md`.
...
### Re-cite lib/render/frontier.mjs:50 at README line 25 to the alias join

Carried in `data/carried/j-20260907-15-carry-2.md`.
...
- `data/carried/j-20260907-15-carry-1.md`
- `data/carried/j-20260907-15-carry-2.md`
