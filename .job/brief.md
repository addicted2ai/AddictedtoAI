...
5 requirements omitted here: the pending amendment below restates them in full. Quoting both would spend the excerpt budget on superseded text and hand you two versions of one rule.
...
### PENDING AMENDMENT to `specs/pulse` — in-flight change `two-desks-work-orders-and-trains`
(full text: `D:/AddictedtoAI/openspec/changes/two-desks-work-orders-and-trains/specs/pulse/spec.md`)
