...
Note that the delta review's gates report is stale in the same way the diff is

- **Target**: `data/proposals/delta-review-brief-embeds-pre-revision-diff.md`
