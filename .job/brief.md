...
Complete the reason list in the proposal's summary — three more non-publish reasons exist

- **Target**: `data/proposals/surface-the-publish-steps-discarded-result.md`
