...
Cross-reference the new machinery proposal with expiration-dates-that-never-arrive

- **Target**: `data/proposals/deferred-expiration-dates-emit-no-signal.md`
