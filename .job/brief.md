...
Attribute the Hermes workspace-trust claim to The Hacker News, or drop Hermes from that sentence

- **Target**: `content/blog/gitspawn-git-config-code-execution-coding-agents.md`
