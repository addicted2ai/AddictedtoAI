...
A declared feed row vanished: openrouter-models qwen/qwen3.8-max

- **Target**: `content/wiki/model/qwen-qwen3-8-max.md`
- **Subject**: `openrouter-models:qwen/qwen3.8-max`
