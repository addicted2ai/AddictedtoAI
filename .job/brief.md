...
A declared feed row vanished: openrouter-models z-ai/glm-5.2:free

- **Target**: `content/wiki/model/z-ai-glm-5-2-free.md`
- **Subject**: `openrouter-models:z-ai/glm-5.2:free`
