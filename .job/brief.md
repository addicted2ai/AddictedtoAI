...
Restore the "for early lead times" qualifier on the WeatherNext CRPS figures

- **Target**: `data/proposals/weathernext-3-tops-operational-weatherbench.md`
