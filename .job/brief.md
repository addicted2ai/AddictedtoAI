...
Note that K2.5's catalog row is still live, so the co-listing has not ended

- **Target**: `content/wiki/model/moonshotai-kimi-k3.md`
...
### PENDING AMENDMENT to `specs/site` — in-flight change `make-the-site-machine-readable`
(full text: `D:/AddictedtoAI/openspec/changes/make-the-site-machine-readable/specs/site/spec.md`)
