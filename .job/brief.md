...
A declared feed row vanished: openrouter-models minimax/minimax-m2.7:free

- **Target**: `content/wiki/model/minimax-minimax-m2-7-free.md`
- **Subject**: `openrouter-models:minimax/minimax-m2.7:free`
