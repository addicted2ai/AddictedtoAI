...
A declared feed row vanished: openrouter-models minimax/minimax-m3:free

- **Target**: `content/wiki/model/minimax-minimax-m3-free.md`
- **Subject**: `openrouter-models:minimax/minimax-m3:free`
