...
- `content/wiki/model/mistralai-codestral-2508-batch.md` (item 1)
...
- `content/wiki/model/mistralai-codestral-2508-batch.md`: graph: absent — no graph index wired on the brief path
