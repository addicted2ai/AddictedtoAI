...
Clear the 2 carried findings on content/blog/openai-astra-critical-designation.md

- **Target**: `content/blog/openai-astra-critical-designation.md`

2 findings carried by reviewers against `content/blog/openai-astra-critical-designation.md`, batched into one job because they concern the same file. Each is stated below in the reviewing reviewer's own words. Fix every one, or say in `RESULT.md` which you did not and why — a finding you leave standing must keep its file.

### Restore the "with the right tools and access" qualifier on the capability sentence

Carried in `data/carried/j-20260903-05-carry-1.md`.
...
### Drop or qualify "independently" in the SecurityWeek sentence

Carried in `data/carried/j-20260903-05-carry-2.md`.
...
- `data/carried/j-20260903-05-carry-1.md`
- `data/carried/j-20260903-05-carry-2.md`
