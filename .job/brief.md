...
`job/j-20260913-05`. Everything you need is in this file and in the repository around
you. There is no prior conversation to recall and no session to resume.

- **Branch**: `job/j-20260913-05`
...
- **Work source**: proposal (proposal `mistral-large-2512-batch-unretire`)

## The outcomes (2 items, governing type `repair`)

### Item 1/2 — `repair` — `content/wiki/model/mistralai-codestral-2508-batch.md`, `content/wiki/model/mistralai-mistral-large-2512-batch.md`

Restore the mistral-large-2512-batch entry to live form

### Item 2/2 — `repair` — `content/wiki/model/mistralai-codestral-2508-batch.md`, `content/wiki/model/mistralai-mistral-medium-3-1-batch.md`

Restore the mistral-medium-3-1-batch entry to live form

The entry is retired and dormant with no feeds binding while its OpenRouter row is live again: present in the committed snapshot, removed once on 2026-09-01 and relisted on 2026-09-10. Restore it to the site's live-entry form.
...
This is **one job with 2 outcomes under one scope rule** (governing type
`repair`). It ends in exactly one merge or one discard. Do not widen
it: a diff that exceeds the stated outcomes is a `scope-violation` at review
and the whole job is rejected for it.

## Subjects (3 subjects, governing type `repair`)

- `content/wiki/model/mistralai-codestral-2508-batch.md` (items 1, 2)
- `content/wiki/model/mistralai-mistral-large-2512-batch.md` (item 1)
- `content/wiki/model/mistralai-mistral-medium-3-1-batch.md` (item 2)



[... CUT: graph context for "content/wiki/model/mistralai-codestral-2508-batch.md", "content/wiki/model/mistralai-mistral-large-2512-batch.md", "content/wiki/model/mistralai-mistral-medium [... CUT]
## Acceptance checks
